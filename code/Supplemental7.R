...
grDevices::png(file = "figures/SupplementalFigure7.png", width = 600*f, height = 550*f)
...
# Precipitation
mgcv::plot.gam(mgcv::gam(pval ~ s(ppt), data = conserved_univar),
               residuals = FALSE,
               all.terms = FALSE,
               shade = TRUE,
               col = "black",
               ...
               ylab = "p-value",
               select = 1,
               shift = stats::coef(mgcv::gam(pval ~ s(ppt), data = conserved_univar))[1],
               ylim = c(-0.1, 1.1),
               cex = 1*f,
               cex.axis = 1*f,
               cex.lab = 1*f)
graphics::abline(h = 0.025, col = "black", lwd = 1*f, lty = 2)
graphics::abline(h = 0.975, col = "black", lwd = 1*f, lty = 2)
# Maximum Temperature
mgcv::plot.gam(mgcv::gam(pval ~ s(tmax), data = conserved_univar),
               residuals = FALSE,
               all.terms = TRUE,
               shade = TRUE,
               col = "black",
               ...
               ylab = "p-value",
               select = 1,
               shift = stats::coef(mgcv::gam(pval ~ s(tmax), data = conserved_univar))[1],
               ylim = c(-0.1, 1.1),
               cex = 1*f,
               cex.axis = 1*f,
               cex.lab = 1*f)
...
graphics::abline(h = 0.975, col = "black", lwd = 1*f, lty = 2)
# Mean Temperature
mgcv::plot.gam(mgcv::gam(pval ~ s(tmean), data = conserved_univar),
               residuals = FALSE,
               all.terms = TRUE,
               shade = TRUE,
               col = "black",
               ...
               ylab = "p-value",
               select = 1,
               shift = stats::coef(mgcv::gam(pval ~ s(tmean), data = conserved_univar))[1],
               ylim = c(-0.1, 1.1),
               cex = 1*f,
               cex.axis = 1*f,
               cex.lab = 1*f)
...
graphics::abline(h = 0.975, col = "black", lwd = 1*f, lty = 2)
# Minimum Temperature
mgcv::plot.gam(mgcv::gam(pval ~ s(tmin), data = conserved_univar),
               residuals = FALSE,
               all.terms = TRUE,
               shade = TRUE,
               col = "black",
               ...
               ylab = "p-value",
               select = 1,
               shift = stats::coef(mgcv::gam(pval ~ s(tmin),data = conserved_univar))[1],
               ylim = c(-0.1, 1.1),
               cex = 1*f,
               cex.axis = 1*f,
               cex.lab = 1*f)
...
mgcv::plot.gam(mgcv::gam(pval ~ s(tdmean), data = conserved_univar),
               residuals = FALSE,
               all.terms = TRUE,
               shade = TRUE,
               col = "black",
               ...
               ylab = "p-value",
               select = 1,
               shift = stats::coef(mgcv::gam(pval ~ s(tdmean), data = conserved_univar))[1],
               ylim = c(-0.1, 1.1),
               cex = 1*f,
               cex.axis = 1*f,
               cex.lab = 1*f)
...
mgcv::plot.gam(mgcv::gam(pval ~ s(vpdmax), data = conserved_univar),
               residuals = FALSE,
               all.terms = TRUE,
               shade = TRUE,
               col = "black",
               ...
               ylab = "p-value",
               select = 1,
               shift = stats::coef(mgcv::gam(pval ~ s(vpdmax), data = conserved_univar))[1],
               ylim = c(-0.1, 1.1),
               cex = 1*f,
               cex.axis = 1*f,
               cex.lab = 1*f)
...
graphics::abline(h = 0.975, col = "black", lwd = 1*f, lty = 2)
# Maximum Vapor Pressure Deficit
mgcv::plot.gam(mgcv::gam(pval ~ s(vpdmin), data = conserved_univar),
               residuals = FALSE,
               all.terms = TRUE,
               shade = TRUE,
               col = "black",
               ...
               ylab = "p-value",
               select = 1,
               shift = stats::coef(mgcv::gam(pval ~ s(vpdmin), data = conserved_univar))[1],
               ylim = c(-0.1, 1.1),
               cex = 1*f,
               cex.axis = 1*f,
               cex.lab = 1*f)
...
graphics::abline(h = 0.975, col = "black", lwd = 1*f, lty = 2)
# Elevation
mgcv::plot.gam(mgcv::gam(pval ~ s(elev), data = conserved_univar),
               residuals = FALSE,
               all.terms = TRUE,
               shade = TRUE,
               col = "black",
               ...
               ylab = "p-value",
               select = 1,
               shift = stats::coef(mgcv::gam(pval ~ s(elev), data = conserved_univar))[1],
               ylim = c(-0.1, 1.1),
               cex = 1*f,
               cex.axis = 1*f,
               cex.lab = 1*f)
